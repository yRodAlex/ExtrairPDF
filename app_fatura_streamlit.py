...
menu = st.sidebar.radio("Menu", ["📁 Converter Fatura PDF → DRE", "📊 Analisar Arquivo DRE"])
...
if menu == "📊 Analisar Arquivo DRE":
    st.header("Análise Completa de DRE")

    arquivo = st.file_uploader("Importe o arquivo DRE (.xlsx ou .xlsm):", type=["xlsx", "xlsm"])
        ...
        try:
            ...
            if abas_validas:
                ...
                if todas_entradas:
                    ...
                    categorias = st.multiselect("Escolha categorias para definir metas:", consolidado["Descrição Conta"].dropna().unique())
                ...
                st.warning("Nenhuma aba válida de lançamentos foi encontrada no arquivo.")
